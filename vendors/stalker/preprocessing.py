...
def crop_start(spatiotemporal_data: pd.DataFrame, time_shift: float=2.0) -> pd.DataFrame:
    ...
    butter_filter = apply_butterworth_filter(spatiotemporal_data, data_to_smooth='median_speed', padding='symmetric', cutoff_freq=2)
    ...
    cropped_spatiotemporal_data['time'] = cropped_spatiotemporal_data['time'] - cropped_spatiotemporal_data['time'].iloc[0]

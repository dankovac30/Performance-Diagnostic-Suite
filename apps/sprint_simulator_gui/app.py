...
class SprintSimulatorApp:
    ...
    def __init__(self, root: tk.Tk):
        ...
        self.style.configure(
            "TLabelframe", background=background_colour, bordercolor=border_colour, relief="solid", borderwidth=1
        )
        ...
        self.style.map(
            ...
            relief=[("pressed", "solid"), ("hover", "solid")],
        )
        self.style.configure(
            "TEntry",
            font=self.base_font,
    ...
    def _create_output_widgets(self, parent_frame: ttk.Frame) -> None:
        ...
        for key, text in output_definitions.items():
            ...
            value_label = ttk.Label(
                output_frame, text="--", width=12, font=(self.base_font[0], self.base_font[1], "bold")
            )

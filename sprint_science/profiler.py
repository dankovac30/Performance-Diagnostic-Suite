...
class SprintProfilation:
    ...
    def calculate_profile(self) -> dict[str, float]:
        ...
        raw_spatiotemporal_data["force"] = apply_butterworth_filter(
        ...
        rename = {"time": "Time (s)", "speed": "1080 Speed (m/s)", "force": "F external load (N)"}
        ...
        spatiotemporal_data["Square differences"] = (
            spatiotemporal_data["Smooth 1080 Speed (m/s)"] - spatiotemporal_data["Model speed (m/s)"]
        ) ** 2
